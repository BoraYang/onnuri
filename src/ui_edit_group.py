...
class Ui_EditGroup(object):
    def setupUi(self, EditGroup):
        ...
        self.gridLayout_2.addWidget(self.btn_add_group, 0, 2, 1, 1)
        ...
        EditGroup.setTabOrder(self.tv_group, self.btn_cancel)
        EditGroup.setTabOrder(self.btn_cancel, self.btn_remove_group)
        EditGroup.setTabOrder(self.btn_remove_group, self.btn_add_group)
