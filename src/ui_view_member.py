...
class Ui_ViewMember(object):
    def setupUi(self, ViewMember):
        ...
        self.rb_gender_male.setCheckable(False)
        ...
        self.rb_gender_female.setCheckable(False)
        ...
        self.lbl_group_info = QtWidgets.QLabel(self.groupBox_2)
        self.lbl_group_info.setObjectName("lbl_group_info")
        self.gridLayout_2.addWidget(self.lbl_group_info, 10, 1, 1, 1)
        ...
        self.chk_new_comer_study.setCheckable(False)
        ...
        self.gridLayout_2.addWidget(self.btn_show_bible_study, 8, 1, 1, 1)
        ...
        self.chk_new_family_study.setCheckable(False)
    ...
    def retranslateUi(self, ViewMember):
        ...
        self.lbl_group_info.setText(_translate("ViewMember", "Group Info"))
