...
class Ui_ViewMember(object):
    def setupUi(self, ViewMember):
        ...
        self.tb_baptism_by.setReadOnly(False)
    ...
    def retranslateUi(self, ViewMember):
        ...
        self.chk_john.setText(_translate("ViewMember", "John"))
        self.chk_romans.setText(_translate("ViewMember", "Romans"))
        self.chk_timothy.setText(_translate("ViewMember", "Timothy"))
