...
class Ui_ViewList(object):
    def setupUi(self, ViewList):
        ...
        self.gridLayout_2.addWidget(self.btn_cancel, 0, 5, 1, 1)
    ...
    def retranslateUi(self, ViewList):
        ...
        ViewList.setWindowTitle(_translate("ViewList", "View Member List"))
        self.lbl_name_input.setText(_translate("ViewList", "Enter Last Name:"))
