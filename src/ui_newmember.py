...
class Ui_NewMember(object):
    def setupUi(self, NewMember):
        ...
        self.gridLayout.addWidget(self.btn_sel_photo, 9, 4, 1, 1)
        self.lbl_photo_loc = QtWidgets.QLabel(self.groupBox)
        self.lbl_photo_loc.setObjectName("lbl_photo_loc")
        self.gridLayout.addWidget(self.lbl_photo_loc, 8, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.lbl_photo_view, 8, 1, 2, 1)
        ...
        self.btn_show_group = QtWidgets.QPushButton(self.groupBox_4)
        self.btn_show_group.setObjectName("btn_show_group")
        self.verticalLayout_4.addWidget(self.btn_show_group)
        ...
        NewMember.setTabOrder(self.cb_duty, self.cb_group)
        NewMember.setTabOrder(self.cb_group, self.chk_new_family_study)
        ...
        NewMember.setTabOrder(self.btn_show_family, self.btn_show_group)
        NewMember.setTabOrder(self.btn_show_group, self.btn_cancel)
    ...
    def retranslateUi(self, NewMember):
        ...
        self.groupBox_4.setTitle(_translate("NewMember", "Group Information"))
        self.btn_show_group.setText(_translate("NewMember", "Show"))
